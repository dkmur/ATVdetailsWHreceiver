...
### notes
# changed wh receiver to include http
# receiver settings + frequency will be moved to /data/local and taken from usb at autoconfig
# autoconfig should add script to /local/bin/sh
# vmapper.sh should lauch script, check if running then pkill+restart
# vmapper.sh to include script version + autoupdate
# removed rom+rgc+mitm+newvhook+litever+useApi
# added vmapper42


## Adjust for your needs
WH_RECEIVER_HOST="http://10.252.1.1"
WH_RECEIVER_PORT="5050"
